--A Kaggle dataset named "paintings" is used in this practice.
--The data tables are listed in the "tables" folder under the main folder.
-------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------

--Write a query to fetch the museums (name and city) that are open on both Monday and Sunday.
...
--Write a query to fetch the museums (name and city) that are not open on Monday.
...
--Write a query to find out which museum is open for the longest during a day? Display museum name, state, opening duration and day.
...
--Write a query to find out which museum has the most paintings of the most popular style? (The most popular style is defined based on the number of panitings of each style).
...
--Write a query to fetch the top 5 museums (name and number of paintings) with the most paintings.
...
--Write a query to find out which country and city have the most museums? 
...
--Identify the artists and the museums where the most expensive and least expensive paintings are placed. 
